...
export default function Navbar() {
	...
	return (
		<nav className="w-full fixed top-0 z-100 flex gap-6 h-[100px]">
			<img src="/battlements-top.webp" className="w-full h-full absolute" alt="Brimvahl-Crown-Navbar-BG" />
			<div className="flex w-11/12 xl:w-5/6">
				<img src="/navbar-logo.webp" className={`h-[220px] relative top-0 transition ease-in-out duration-1000 ${isAtThePageTop ? 'translate-y-[-250px]' : 'translate-y-0'} ml-60`} alt="Brimvahl-Crown-Navbar-Logo" />
				<div className="relative top-[-20px] flex gap-3 ml-10">
					<Link to="/" className="relative text-white hover:text-yellow-500 hover:drop-shadow-[0px_0px_5px_oklch(79.5%_0.184_86.047)]">
						<img src="/navbar-menu-bg-blue.webp" className="w-[160px]" alt="Brimvahl-Crown-Navbar-Menu" />
					...
					<button onClick={() => setIsExpanded(!isExpanded)} className="relative top-[-20px] text-white hover:text-yellow-500 hover:drop-shadow-[0px_0px_5px_oklch(79.5%_0.184_86.047)] flex flex-col items-center">
						{/* Trigger button */}
						<img src="/navbar-menu-bg-red.webp" className={`w-[160px] transition ease-in-out duration-500 transform ${isExpanded ? 'translate-y-0' : 'translate-y-[-150px]'}`} alt="Brimvahl-Crown-Navbar-Menu" />
						...
						<img src="/navbar-more-arrow.webp" className={`absolute transition ease-in-out top-0 duration-500 transform ${isExpanded ? 'translate-y-[220px] rotate-[180deg]' : 'translate-y-[90px] rotate-[0deg]'} left-15 w-[40px]`} alt="Brimvahl-Crown-More-Arrow" />
