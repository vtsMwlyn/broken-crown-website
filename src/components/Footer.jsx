...
export default function Footer() {
  return (
    <footer
      className="w-full text-black md:text-lg lg:text-xl 2xl:text-3xl 3xl:text-4xl flex flex-col items-center relative"
    ...
    >
      <div className="w-11/12 xl:w-5/6 2xl:w-full max-w-5/6 flex flex-col xl:flex-row gap-10 xl:gap-20 py-12 md:py-20 relative z-5">
        {/* Brand */}
        <div className="w-full xl:w-1/3 flex flex-col text-center sm:text-left xl:space-y-5 2xl:space-y-10">
        ...
        <div className="w-full xl:w-2/3 grid grid-cols-1 xl:grid-cols-3 gap-10 xl:gap-0">
          {/* Links 1 */}
          <div className="w-full flex flex-col text-center sm:text-left xl:space-y-5 2xl:space-y-10">
            <h1 className="font-bold mb-4 md:mb-8">Brimvahl Crown</h1>
            ...
            <Link to="#" className="hover:text-yellow-800 hover:font-semibold">Gameplay Feature</Link>
            <Link to="#" className="hover:text-yellow-800 hover:font-semibold">Background</Link>
            <Link to="#" className="hover:text-yellow-800 hover:font-semibold">Merch</Link>
            <Link to="#" className="hover:text-yellow-800 hover:font-semibold">Fan Arts</Link>
          </div>
      ...
      >
        <img
          ...
          className="sm:w-[140px] md:w-[160px] xl:w-[120px] 2xl:w-[160px] 3xl:w-[200px]"
          alt="Brimvahl-Crown-Navbar-Menu"
        />
        <div className="absolute top-4 sm:top-5 md:top-6 text-center w-full text-xs sm:text-sm md:text-base 2xl:text-2xl 3xl:text-3xl">
          Back to<br />Home
        </div>
      </Link>
    </footer>
