const backgrounds = [
	{
		...
		gallery: [
			'/res/backgrounds/kazmielhouse1.webp',
			'/res/backgrounds/kazmielhouse1.webp',
			'/res/backgrounds/kazmielhouse1.webp'
		],
		video: '/res/backgrounds/banditcamp.mp4',
	},
	{
		title: 'Town square',
		...
		gallery: [
			'/res/backgrounds/lowland2.webp',
			'/res/backgrounds/lowland1.webp',
			'/res/backgrounds/lowland3.webp'
		],
		video: '/res/backgrounds/lowland.mp4',
	},
	{
		title: 'Outskirts',
		...
		gallery: [
			'/res/backgrounds/banditcamp1.webp',
			'/res/backgrounds/banditcamp2.webp',
			'/res/backgrounds/banditcamp3.webp'
		],
		video: '/res/backgrounds/banditcamp.mp4',
	},
	// {
	...
	// 	gallery: [
	// 		'/res/backgrounds/colosseum1.webp',
	// 		'/res/backgrounds/colosseum2.webp',
	// 		'/res/backgrounds/colosseum3.webp'
	// 	],
	// 	video: '/res/backgrounds/colosseum.mp4',
	// },
	{
		...
		gallery: [
			'/res/backgrounds/seraphiumarena1.webp',
			'/res/backgrounds/seraphiumarena2.webp',
			'/res/backgrounds/seraphiumarena3.webp'
		],
		video: '/res/backgrounds/colosseum.mp4',
	},
];
