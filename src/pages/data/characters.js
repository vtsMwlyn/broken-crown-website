const characters = [
	// ===== The Elandys Family ===== //
	{
		...
		nickName: 'Mariel',
		sprite: '/assets/characters/sprites/mariel-elandys.webp',
		icon: '/assets/characters/icons/mariel-elandys.webp',
		...
		voiceline: '/assets/characters/voicelines/unknown.ogg',
		VA: 'Xanthe Huynh',
	},
	{
		faction: 'elandys-family',
		...
		nickName: 'Vael',
		sprite: '/assets/characters/sprites/vael.webp',
		icon: '/assets/characters/icons/vael.webp',
	...
	},
	{
		...
		nickName: 'Kazmiel',
		sprite: '/assets/characters/sprites/kazmiel-armor.webp',
		icon: '/assets/characters/icons/kazmiel-armor.webp',
		half: '/assets/characters/half-kazmiel-armor.webp',
		...
		voiceline: '/assets/characters/voicelines/kazmiel-elandys-lowland.mp3',
		VA: 'Brenna Larsen',
	},
	{
		faction: 'elandys-family',
		...
		nickName: 'Flaire',
		sprite: '/assets/characters/sprites/flaire.webp',
		half: '/assets/characters/half-flaire.webp',
		icon: '/assets/characters/icons/flaire.webp',
		...
		voiceline: '/assets/characters/voicelines/flaire-eldryn.mp3',
		VA: 'Lizzie Freeman',
	},
	{
		faction: 'elandys-family',
		...
		fullName: '?????',
		nickName: '?????',
		sprite: '/assets/characters/sprites/deathless-king.webp',
		half: '/assets/characters/half-deathless-king.webp',
		icon: '/assets/characters/icons/deathless-king.webp',
		desc: 'A swordsman with extraordinary powers.',

		voiceline: '/assets/characters/voicelines/deathless-king.mp3',
		VA: 'Andrew Russell',
	},
	...
	// ===== The Brimvahl Guards ===== //
	{
		...
		sprite: '/assets/characters/sprites/female-elite-guard.webp',
		icon: '/assets/characters/icons/female-elite-guard.webp',
		...
		voiceline: '/assets/characters/voicelines/elite-guard-tarva.mp3',
		VA: 'Anna Faye',
	},
	{
		faction: 'brimvahl-guards',
		...
		sprite: '/assets/characters/sprites/male-elite-guard.webp',
		icon: '/assets/characters/icons/male-elite-guard.webp',
		...
		voiceline: '/assets/characters/voicelines/elite-guard-tarvon.mp3',
		VA: 'Leo Culligan',
	},	
	{
		faction: 'brimvahl-guards',
		...
		sprite: '/assets/characters/sprites/brute-guard.webp',
		icon: '/assets/characters/icons/brute-guard.webp',
	...
	},
	{
		...
		sprite: '/assets/characters/sprites/regular-knight.webp',
		icon: '/assets/characters/icons/regular-knight.webp',
	...
	// ===== Fennora Village ===== //
	{
		...
		fullName: 'Kazmiel Elandys',
		nickName: 'Kazmiel',
		sprite: '/assets/characters/sprites/kazmiel.webp',
		half: '/assets/characters/half-kazmiel.webp',
		icon: '/assets/characters/icons/kazmiel.webp',
		desc: 'Mariel’s firstborn, a half-seraph, was born without wings, a mark of no divinity. Yet, when her father was slain, Kazmiel awakened her latent power, manifesting glowing wings and ascending as one of history’s most formidable warriors. Her plundering missions brought immeasurable wealth to Eldynia, but her love for a lowlander led to her abandoning war. Deemed a traitor to the crown, she was exiled, removed from history.',

		voiceline: '/assets/characters/voicelines/kazmiel-the-pantocrator.mp3',
		VA: 'Brenna Larsen',
	},
	{
		faction: 'fennora-village',
		...
		fullName: 'Sata',
		nickName: 'Sata',
		sprite: '/assets/characters/sprites/sata.webp',
		icon: '/assets/characters/icons/sata.webp',
		...
		voiceline: '/assets/characters/voicelines/sata-elandys.mp3',
		VA: 'Hudson Franzoni',
	},
	{
		faction: 'fennora-village',
		...
		fullName: 'Nova',
		nickName: 'Nova',
		sprite: '/assets/characters/sprites/nova.webp',
		icon: '/assets/characters/icons/nova.webp',
	...
	// ===== The Laughing Death ===== //
	{
		...
		fullName: 'Vexa',
		nickName: 'Vexa',
		sprite: '/assets/characters/sprites/vexa.webp',
		icon: '/assets/characters/icons/vexa.webp',
		...
		voiceline: '/assets/characters/voicelines/vexa-yahn.mp3',
		VA: 'Sky Santacruz',
	},
];
