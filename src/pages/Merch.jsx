	...
	return (
		<Link to={merch?.link} target="_blank" className="w-full flex flex-col items-start relative hover:drop-shadow-[0px_0px_5px_oklch(79.5%_0.184_86.047)] cursor-pointer">
			<div className="w-full h-full relative flex items-center justify-center">
				<img src="/merch-card-horizontal.webp" className="w-[400px] h-[250px]" alt="Brimvahl-Crown-Merch-Border" />
			...
			<div className="w-fit h-fit py-2 px-4 absolute left-5 bottom-[-15px] z-5" style={{ background: `url('/merch-label.webp') no-repeat center center / cover` }}>
...
function TableMerch({ merch }) {
	return (
		<Link to={merch?.link} target="_blank" className="relative max-w-[300px] h-90 flex flex-col items-center hover:drop-shadow-[0px_0px_5px_oklch(79.5%_0.184_86.047)] cursor-pointer">
			...
			<img src="/merch-carpet.webp" className="w-60 absolute left-0 top-55 ml-10" alt="Brimvahl-Crown-Merch-Carpet" />
			<div className="w-fit h-fit py-2 px-4 absolute left-0 top-65" style={{ background: `url('/merch-label.webp') no-repeat center center / cover` }}>
...
export default function Merch() {
	...
	return (
		<>
			<div className="w-full flex justify-center relative min-h-screen" id="merchs" style={{ background: `url('/merch-bg.webp') no-repeat center center / cover` }}>
				<div className="w-full flex flex-col justify-between items-center">
					...
					<div className="flex flex-col items-center absolute top-26 right-10">
						...
						<img src="/underline-white.webp" className="w-2/5" alt="Brimvahl-Crown-Underline" />
					</div>
					...
					<div className="w-full flex items-center justify-center gap-20 relative bottom-0">
						{/* Table BG */}
						<img src="/merch-table.webp" className="absolute w-full h-full z-1 pt-20" alt="Brimvahl-Crown-Merch-Table" />

						{/* Character */}
						<img src="/merch-npc.webp" className="absolute right-100 bottom-120 h-[600px]" alt="Brimvahl-Crown-Merch-NPC" />
